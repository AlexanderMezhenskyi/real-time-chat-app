...
test('App should have correct initial render', () => {
  ...
  const incrementValueInput = screen.getByLabelText<HTMLInputElement>('Set increment amount')
...
test('Increment value and Decrement value should work as expected', async () => {
  ...
  const incrementValueButton = screen.getByLabelText<HTMLButtonElement>('Increment value')

  const decrementValueButton = screen.getByLabelText<HTMLButtonElement>('Decrement value')
